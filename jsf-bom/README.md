...
| [jsf-common-dependencies](./jsf-common-dependencies) | JSF 通用模块（jsf-pojo / jsf-util） |
...
└── jsf-dependencies (聚合入口)
    ...
    ├── jsf-common-dependencies       (jsf-pojo / jsf-util)
    ├── jsf-components-dependencies   (jsf-wsf 等组件)
