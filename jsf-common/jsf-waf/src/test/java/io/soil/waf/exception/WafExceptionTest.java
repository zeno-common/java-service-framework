...
/**
 * {@link WafException} 单元测试
 */
public class WafExceptionTest {

    // ==================== 构造函数测试 ====================

    @Test
    public void constructor_withMsg_shouldDefaultTo500() {
        WafException ex = new WafException("error message");
    ...
    public void constructor_withMsgPattern_shouldFormatMessage() {
        WafException ex = new WafException("item {0} not found in {1}", "123", "order");
    ...
    public void constructor_withStatusAndMsg_shouldSetCorrectStatus() {
        WafException ex = new WafException(HttpStatus.NOT_FOUND, "not found");
    ...
    public void constructor_withStatusAndMsgPattern_shouldFormatAndSetStatus() {
        WafException ex = new WafException(HttpStatus.BAD_REQUEST, "field {0} is invalid", "email");
    ...
    public void constructor_withCodeAndStatusAndMsgPattern_shouldFormatAndSetCustomCode() {
        WafException ex = new WafException("ERR-002", HttpStatus.CONFLICT, "duplicate {0}", "email");
    ...
    public void constructor_withThrowable_shouldDefaultTo500() {
        ...
        WafException ex = new WafException(cause);
    ...
    public void constructor_withCodeAndThrowable_shouldSetStatus() {
        RuntimeException cause = new RuntimeException("root cause");
        WafException ex = new WafException("SYS-ERR", cause);
    ...
    public void constructor_withCodeAndThrowableAndMsgPattern_shouldCreateException() {
        ...
        WafException ex = new WafException("ERR-003", cause, "override {0}", "msg");
    ...
    public void constructor_fullArgs_shouldSetAllFields() {
        RuntimeException cause = new RuntimeException("root");
        WafException ex = new WafException("CODE-X", HttpStatus.FORBIDDEN, cause, "access {0} denied", "resource");
    ...
    public void status_shouldReturnHttpStatus() {
        WafException ex = new WafException(HttpStatus.UNAUTHORIZED, "unauthorized");
    ...
    public void code_shouldReturnCustomCode() {
        WafException ex = new WafException("CUSTOM-CODE", HttpStatus.OK, "ok");
